...
class DeljitMessage(SegmentGroup):
    ...
    # 12,13,14 SG2
    driver_information = Loop(DejitNamesAddressFullInformation, max=1, mandatory=True)
    # 15 SG2
    supplier_info = Loop(DejitNamesAddressInformation, max=1, mandatory=True)
    # 16 SG2
    recipient_info = Loop(DejitNamesAddressInformation, max=1, mandatory=True)
    # 17-29 SG4
    delivery_sequence = Loop(DejitDeliverySequenceDetail, max=9999, mandatory=True)
    # 30
